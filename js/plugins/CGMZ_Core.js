 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version removes some deprecated code. If you get an
 * error after updating, please update other [CGMZ] plugins.
 *
 * This update also added a function for getting the height of a window that
 * contains a mixture of static and selectable lines.
 *
 * A bug was fixed with horizontally scrolling [CGMZ] Windows with custom
 * padding values.
 *
 * Version 1.23.0
...
var CGMZ = {};
CGMZ.Versions = {};
CGMZ.Versions["CGMZ Core"] = "1.23.0";
CGMZ.Core = {};
